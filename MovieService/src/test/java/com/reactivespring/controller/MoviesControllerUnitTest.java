...
public class MoviesControllerUnitTest {
    ...
    void retrieveMovieById() {
        ...
        when(moviesInfoRestClient.retrieveMovieInfo(anyString()))
                .thenReturn(Flux.just(new MovieInfo(movieId, "Batman Begins",
    ...
    void retrieveMovieById_404() {
        ...
        when(moviesInfoRestClient.retrieveMovieInfo(anyString()))
                .thenReturn(Flux.error(new MoviesInfoClientException("MovieNotFound", 404)));
    ...
    void retrieveMovieById_500() {
        ...
        when(moviesInfoRestClient.retrieveMovieInfo(anyString()))
                .thenReturn(Flux.error(new MoviesInfoServerException(errorMsg)));
